#!/usr/bin/env python3
"""Deprecated Cppcheck-only forwarding entry point for Code Analyzer."""
...
if __name__ == "__main__":
    ...
    if not any(value == "--out" or value.startswith("--out=") for value in arguments):
        arguments = ["--out", "cppcheck-report"] + arguments
    raise SystemExit(main(["--tools", "cppcheck"] + arguments))
